...
\begin{itemize}
    ...
    \begin{tikzpicture}[roundnode/.style={circle, draw=blue!60, fill=blue!5, ultra thick, minimum size=7mm},]
        ...
        \node[roundnode](leftcirlce)[below= of maintopic]{2};
        \node[roundnode](leftcirlce)[below= of leftcirlce]{6};
        \node[roundnode](leftcirlce)[below= of leftcirlce]{7};
        \node[roundnode](leftcirlce)[below= of leftcirlce]{11};
        \node[roundnode](rightcirlce)[right= of maintopic]{1};
        \node[roundnode](rightcirlce)[below= of rightcirlce]{2};
        \node[roundnode](rightcirlce)[below= of rightcirlce]{6};
        \node[roundnode](rightcirlce)[below= of rightcirlce]{7};
        \node[roundnode](rightcirlce)[below= of rightcirlce]{11};

        %Lines
        \draw[->](leftcirlce.east)--(rightcirlce.west);
    \end{tikzpicture}
    \item Matrix:\\
        $\begin{pNiceMatrix}[first-row,first-col]
           & 1 & 2 & 6 & 7 & 11  \\
