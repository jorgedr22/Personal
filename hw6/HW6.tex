...
\begin{itemize}
    ...
    \begin{multicols}{2}
        ...
        \end{itemize}
        \item R is not an equivalence relation because R is not symmetric.
    \end{multicols} 
\end{itemize}
...
\begin{multicols}{2}
    ...
    \item \begin{itemize}
       ...
       \item R is not antireflexive since 0 points to itself
...
\begin{itemize}
    ...
    \begin{multicols}{2}
        ...
        \item \begin{itemize}
            \item R is reflexive as the diagnol consist of only 1's. R is symmetric R is symmetric as since $\forall$ m and n, (m, n) and (n, m) are 1s. For example, in this set, 
            there exists elements (1, 7) and (2,11) in order for the set to be symmetrical, there has to exist elements (7, 1) and (11, 2) and because those elements exist in the set R,
             we are to claim that set R is symmetrical as this thought process can be applied to all elements of set R..R is transitive as $\forall$ $m$ and $n \in R$, if $mRn$ and $nRm$ 
            then $mRm$ and $nRn$.
        \end{itemize}
        \item R is an equivalence relation since it is reflexive, symmetric, and transitive. The equivalence class for R are: 
            \begin{itemize}
                \item $[1] = {1, 7}$ $[2] = {2, 11}$ $[6] = {6}$
            \end{itemize}    
    \end{multicols}
\end{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item Let $A \in P(X)$:\\
                ...
                $\Rightarrow$ $A \nsim A$.\\
                Since the choice of relation A is completely arbritiary, we can say that relation $A$ is 
